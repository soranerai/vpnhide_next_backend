...
assert_detected android14-6.1 '6.1.75-custom-kernel'
assert_detected android12-5.10 '5.10.198-Performance-GKI+'
assert_detected android13-5.15 '5.15.153-custom-kernel'
assert_detected android15-6.6 '6.6.30-Wild+'
assert_detected android16-6.12 '6.12.23-custom-kernel'

vpnhide_kmi_matches android14-6.1 '6.1.75-android14-11-gabcdef'
vpnhide_kmi_matches android14-6.1 '6.1.145+blue-spark'
...
if vpnhide_detect_gki 'invalid-kernel-name' >/dev/null; then
    echo 'FAIL: invalid kernel name was accepted' >&2
    exit 1
fi
